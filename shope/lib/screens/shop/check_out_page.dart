...
class _CheckOutPageState extends State<CheckOutPage> {
  ...
  List<Product> products = [
    Product('assets/headphones.png', 'Boat roackerz 400 Headphones', '', 453),
    Product('assets/headphones_2.png', 'Boat roackerz 100 Headphones', '', 223),
    Product('assets/headphone_13.png', 'Boat roackerz 300 Headphones', '', 583),
  ];
