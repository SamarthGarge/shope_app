                                ...
                                : Align(
                                    ...
                                    child: Row(
                                      ...
                                      children: <Widget>[
                                        InkWell(
                                            onTap: () =>
                                                Navigator.of(context).push(MaterialPageRoute(builder: (_) => SendPage())),
                                            child: Text('Pay')),
                                        InkWell(
                                            onTap: () =>
                                                Navigator.of(context).push(MaterialPageRoute(builder: (_) => RequestPage())),
                                            child: Text('Request')),
                                      ],
                                    ),
                                  ),
                                  ...
                                  ...users
                                      .map((user) => InkWell(
                                            onTap: () => Navigator.of(context)
                                                .push(MaterialPageRoute(builder: (_) => RequestAmountPage(user))),
                                            child: Container(
                                              width: 100,
                                              height: 200,
                        ...
                        itemBuilder: (_, index) => Container(
                          ...
                          child: Column(
                            ...
                            children: <Widget>[
                              ...
                              Padding(
                                padding: const EdgeInsets.symmetric(vertical: 8.0),
                                child: Text('10% off on any pizza hut products',
                                    style: TextStyle(
                                      color: Colors.grey,
                                      fontSize: 10.0,
                                    )),
